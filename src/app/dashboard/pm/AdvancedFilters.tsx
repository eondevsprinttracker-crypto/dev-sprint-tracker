...
export default function AdvancedFilters({
    ...
    return (
        <div className="bg-white backdrop-blur-sm rounded-xl border border-orange-100 p-4 mb-6">
            {/* Search Bar & Toggle */}
            <div className="flex items-center gap-3">
                ...
                <div className="flex-1 relative">
                    ...
                    <input
                        ...
                        className="input-premium w-full pl-10 pr-4 py-2.5 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition"
                    />
                </div>
                ...
                <select
                    ...
                    className="px-3 py-2.5 bg-white border border-orange-100 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-orange-500/30 focus:border-transparent transition"
                >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="w-full px-3 py-2 bg-white border border-orange-100 rounded-lg text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-orange-500/30 focus:border-transparent transition"
                            >
                        ...
                        {/* Blocked Filter */}
                        <div>
                            <label className="block text-xs font-medium text-gray-500 mb-1.5">Blocked State</label>
                            <select
