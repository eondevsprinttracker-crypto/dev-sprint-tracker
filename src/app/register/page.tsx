...
import { registerWithGoogle } from "@/app/actions/authActions";
    ...
    return (
        <div className="min-h-screen bg-[#050505] flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden">
                {/* Gradient orbs */}
                <div className="absolute top-1/3 right-1/4 w-[500px] h-[500px] bg-orange-600/15 rounded-full blur-[100px] animate-blob" />
                <div className="absolute bottom-1/3 left-1/4 w-[400px] h-[400px] bg-orange-500/10 rounded-full blur-[80px] animate-blob" style={{ animationDelay: '2s' }} />
            ...
            <div className="w-full max-w-md relative z-10 animate-slide-up">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-neutral-400">Join as a Developer</p>
                </div>
                ...
                <div className="glass-modal rounded-2xl p-8 animate-scale-in-bounce relative overflow-hidden">
                    ...
                    <div className="flex items-center justify-center mb-4">
                        <div className="p-3 bg-gradient-to-br from-orange-500/20 to-orange-600/10 rounded-2xl border border-orange-500/20">
                    ...
                    <h2 className="text-2xl font-semibold text-white mb-2 text-center">Developer Sign Up</h2>
                    <p className="text-neutral-500 text-sm text-center mb-6">
                        Create your developer account with Google
                    </p>
                ...
                <div className="mt-6 p-4 glass rounded-xl border border-neutral-800/50 animate-fade-in" style={{ animationDelay: '0.3s' }}>
                    <div className="flex items-center justify-center gap-3 text-neutral-400 text-xs">
                        <span className="p-1.5 bg-orange-500/10 rounded-lg">
                            <svg className="w-4 h-4 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                            </svg>
                        </span>
                        <span>You will be registered as a <span className="text-orange-400 font-medium">Developer</span></span>
                    </div>
                </div>
